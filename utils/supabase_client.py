...
SUPABASE_URL = os.getenv("SUPABASE_URL", "https://oixatobhvywjxjxeaisu.supabase.co")
SUPABASE_KEY = os.getenv("SUPABASE_KEY", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9peGF0b2JoeXZ3andjeHhlaXN1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzM1NDE5MzEsImV4cCI6MjA4OTExNzkzMX0.2_WvXWbtdNRBoIe9jn92xtLKdmXWVZina_barNV_alY")
